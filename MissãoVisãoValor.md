...
* Simplicidade Técnica: Desenvolver uma solução em C# com telas fáceis e intuitivas, eliminando burocracias na rotina de quem opera o estoque.

* Respeito ao Consumidor: Entender que cada par de sapatos vendido representa a expectativa de um cliente, tornando a pontualidade e a numeração correta nossa prioridade máxima.
